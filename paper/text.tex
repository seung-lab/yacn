...
The number of errors from the set in $\ref{sec:detection_results}$ that were fixed or introduced by our iterative refinement procedure is shown in \ref{table:errors_fixed}.  Our iterative refinement procedure fixed a significant fraction of the remaining errors.
...
\begin{table}[h]
  \caption{Number of errors fixed and introduced relative to the baseline. These numbers should be taken with a grain of salt since topologically insignificant changes could result in errors.}
