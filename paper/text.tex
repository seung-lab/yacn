...
segmentation, we claim that our model architecture is more general as evidenced
in the diverse shape of boundary detection, error-detecting and error-correcting
nets~(Figure~\ref{fig:architecture} and Figure~A1 in the appendix).
